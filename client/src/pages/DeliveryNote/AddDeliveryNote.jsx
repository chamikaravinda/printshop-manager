...
import { addDeliveryNote } from "../../actions/delivery-note.action";
...
const AddDeliveryNote = () => {
  ...
  const handleSubmit = (e) => {
    ...
    addDeliveryNote(newDeliveryNote, success);
  };
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold mb-6">Create Delivery Notes</h2>
